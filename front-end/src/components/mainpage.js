      ...
      <div>
        {currentQuestionIndex < questionsList.length ? (
          <div>
            ...
            <Webcam ref={this.webcamRef} /> {/* Assuming you have a Webcam component */}
            <button onClick={this.handleStartCaptureClick} disabled={isRecording}>Start Record</button>
            <button onClick={this.handleStopCaptureClick} disabled={!isRecording}>Stop Record</button>
            {currentQuestionIndex === questionsList.length - 1 ? (
              <div>
              <button onClick={this.handleSubmit}>Submit and Process the Result</button>
